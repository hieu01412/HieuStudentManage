<?php
namespace Lof\HieuStudentManage\Ui\Component\Student;
...
class MassActions extends AbstractComponent
{
    ...
    public function isActionAllowed($actionType) : bool
    {
        ...
        switch ($actionType) {
            case 'delete':
                $isAllowed = $this->authorization->isAllowed('Lof_HieuStudentManage::student');
                break;
            default:
                break;
        }
